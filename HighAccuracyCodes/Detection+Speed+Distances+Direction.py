...
def main(video_path, output_path):
    ...
    while True:
        ...
        # Estimate direction and turning
...
output_path = 'S:\Files\Work\College\Year3\Sem-6\Sem-Project\Outputs\Detection_Distance_Speed_Direction_OutputVideo-2.mp4'
